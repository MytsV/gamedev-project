...
const connectionHandler = (message: TConnectionMessage, rinfo: dgram.RemoteInfo) => {
...
const eventHandlers = new Map<EventType, (message: any, rinfo: dgram.RemoteInfo) => void>([
  [EventType.CONNECTION, connectionHandler],
  [EventType.MOVE, moveHandler]
]);

export const handleMessage = (message: TBaseMessage, rinfo: dgram.RemoteInfo) => {
